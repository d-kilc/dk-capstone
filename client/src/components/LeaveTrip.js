...
export default function LeaveTrip({ handleToggleModal, id }) {
    ...
    return (
        <Grid container spacing={2}>
            ...
            <Grid item xs={12} m={2} >
                <Typography variant="h6" textAlign="center">Are you sure? If you wish to re-join the trip, you will have to be re-invited. This action cannot be undone.</Typography>
            </Grid>
            <Grid item xs={12} m={2} display='flex' justifyContent='space-between'>
                <Button color="error" onClick={() => handleLeaveTrip(id)}>Yes, I'm sure</Button>
